...
class _ChatScreenState extends State<ChatScreen> {
  ...
  // PageStorageKey + keepScrollOffset preserve the scroll position
  // when this screen is rebuilt within the same PageStorage context.
  ...
  Future<void> _sendMessage() async {
    ...
    await _chatService.streamMessage(
      ...
      onFinal: (data) {
        ...
        // No automatic scrolling after the assistant responds.
      },
    );
  }
      ...
      MaterialPageRoute(
        ...
        builder: (_) => VoiceModeScreen(
          ...
          onExchangeComplete: (userMsg, assistantMsg) {
            ...
            // No automatic scrolling after voice messages.
          },
        ),
      ),
    );
  ...
  Future<void> _regenerateMessage(String messageId) async {
    ...
    await _chatService.regenerateMessage(
      ...
      onFinal: (data) {
        ...
        // No automatic scrolling after regeneration.
      },
    );
  }
  ...
  Future<void> _continueMessage(String messageId) async {
    await _chatService.continueMessage(
      ...
      onChunk: (chunk) {
        ...
        // Do not force-scroll during streaming.
      },
      onFinal: (data) {
        if (!mounted) return;
        ...
        // No automatic scrolling after continuing.
      },
    );
  }
